...
function start() {
    ...
    // Obtener imagen como base64 desde canvas
    ...
    for (var f = 0; f < MAGNITUD; f++) {
        ...
        fila.className = "fila";
        fila.style.height = ((H / MAGNITUD) * 100) / H + "%";
        ...
        for (var i = 0; i < MAGNITUD; i++) {
            ...
            divC.style.flexBasis = ((W / MAGNITUD) * 100) / W + "%";
    ...
    // Ocultar la imagen de referencia cuando empieza el juego
...
function gameOver() {
    ...
    msg.textContent = "¡¡ FELICIDADES COMPLETASTE EL ROMPE-CABEZAS !!";
...
// MOSTRAR / OCULTAR imagen de referencia
function togglePreview() {
    const previewBox = document.getElementById("imgPreviewBox");
    if (!previewBox) return;
    previewBox.style.display = (previewBox.style.display === "none" || previewBox.style.display === "") ? "block" : "none";
}
